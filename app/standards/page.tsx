    ...
    <main className="min-h-screen bg-theme-bg px-6 py-16 text-theme-text md:py-24">
      <article className="mx-auto max-w-3xl">
        ...
        <section className="mt-12 space-y-8 border-t border-theme-border pt-10">
          ...
          <div>
            <h2 className="font-serif text-xl text-theme-text">Borosilicate glass</h2>
            <p className="mt-3 text-sm leading-relaxed text-theme-muted">
          ...
          <div>
            <h2 className="font-serif text-xl text-theme-text">Botanical massage oils</h2>
            <p className="mt-3 text-sm leading-relaxed text-theme-muted">
          ...
          <div>
            <h2 className="font-serif text-xl text-theme-text">Mulberry silk</h2>
            <p className="mt-3 text-sm leading-relaxed text-theme-muted">
