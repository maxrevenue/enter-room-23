    ...
    <article className="group flex h-full flex-col">
        ...
        <div className="relative aspect-[4/5] overflow-hidden bg-zinc-900">
          {imageSrc ? (
            ...
            <div className="flex h-full w-full flex-col items-center justify-center bg-zinc-950">
              <span className="text-[10px] font-medium uppercase tracking-[0.32em] text-zinc-600">
                Room 23
              </span>
            </div>
          )}
          ...
          {product.badge && !soldOut ? (
            <span className="absolute left-3 top-3 text-[10px] font-medium uppercase tracking-[0.2em] text-zinc-300">
              {product.badge}
            </span>
          ) : null}

          {soldOut ? (
            <span className="absolute inset-0 flex items-center justify-center bg-zinc-950/60 text-[10px] font-medium uppercase tracking-[0.22em] text-zinc-300">
              Sold out
            </span>
          ) : null}
        </div>
      ...
      <div className="flex flex-1 flex-col px-0.5 pt-5 sm:pt-6">
        <Link
          ...
          className="block focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-zinc-500"
        >
          <h3 className="font-serif text-[15px] leading-snug tracking-wide text-zinc-50 transition-colors duration-300 group-hover:text-white sm:text-base">
            {product.name}
          </h3>
        </Link>
