module MidnightLounge.Components.Header
            ...
            Html.div [
                ...
                prop.children [
                    Html.a [
                        ...
                        prop.children [
                            Html.span [ prop.className "header__logo-mark"; prop.text "Midnight" ]
                            Html.span [ prop.className "header__logo-accent"; prop.text "Lounge" ]
                        ]
                    ]
                    ...
                    Html.nav [
                        ...
                        prop.children [
                            ...
                            navItem "Night Apparel" "header-nav-night-apparel"
                                (model.Filter = ByCategory NightApparel)
                                (fun () -> selectAndScroll (ByCategory NightApparel))
                            navItem "Sensory Tech" "header-nav-sensory-tech"
                                (model.Filter = ByCategory SensoryTech)
                                (fun () -> selectAndScroll (ByCategory SensoryTech))
                        ]
                    ]
                        ...
                        prop.children [
                            Html.button [
                                ...
                                prop.children [
                                    ...
                                    if count > 0 then
                                        Html.span [
                                            // Re-keying on count replays the pop animation.
