...
export const PRODUCTS = [
  ...
  },
  {
    ...
    gallery: [],
    relatedSlugs: ['platinum-silicone-lubricant-4oz', 'skins-delay-spray'],
  },
  {
    id: 'skins-delay',
    ...
    images: [
      ...
      { url: '/images/products/skins-delay/hero.jpg', alt: 'SKINS Delay Spray box and bottle, spray labeling' },
  ...
  },
  {
    ...
    image: '/images/products/heli-lavender-mist/bottle.jpg',
    images: [
      { url: '/images/products/heli-lavender-mist/bottle.jpg', alt: 'HéLi Lavender & Chamomile Refreshing Fragrance Mist bottle' },
      { url: '/images/products/heli-lavender-mist/packshot.jpg', alt: 'HéLi Lavender & Chamomile mist, isolated' },
      { url: '/images/products/heli-lavender-mist/botanical.jpg', alt: 'HéLi mist with lavender and chamomile' },
      { url: '/images/products/heli-lavender-mist/lifestyle.jpg', alt: 'HéLi Lavender & Chamomile mist on a pedestal' },
      { url: '/images/products/heli-lavender-mist/label-detail.jpg', alt: 'HéLi Lavender & Chamomile mist label' },
    ],
    fulfillmentType: FULFILLMENT_TYPES.WHITE_LABEL,
    vendorType: VENDOR_TYPES.ROOM23_STOCK,
    inventoryStatus: INVENTORY_STATUS.IN_STOCK,
  ...
  },
  {
    ...
    image: '/images/products/arlo-atlas-oil/packshot.jpg',
    images: [
      { url: '/images/products/arlo-atlas-oil/packshot.jpg', alt: 'Arlo & Co. Atlas Tobacco & Citron hydrating body oil' },
    ],
    fulfillmentType: FULFILLMENT_TYPES.WHITE_LABEL,
    vendorType: VENDOR_TYPES.ROOM23_STOCK,
    inventoryStatus: INVENTORY_STATUS.IN_STOCK,
    ...
    gallery: [],
    relatedSlugs: ['heli-lavender-chamomile-mist', 'dirty-french-shower-gel', 'secret-garden-fragrance-mist'],
  },
  {
    ...
    image: '/images/products/pr-secret-garden-mist/packshot.jpg',
    images: [
      { url: '/images/products/pr-secret-garden-mist/packshot.jpg', alt: 'Secret Garden Watercress & Lily fragrance mist' },
  ...
  },
  {
    ...
    image: '/images/products/pr-dirty-french-gel/packshot.jpg',
    images: [
      { url: '/images/products/pr-dirty-french-gel/packshot.jpg', alt: 'Dirty French Shower Gel & Bubble Bath bottle' },
      { url: '/images/products/pr-dirty-french-gel/lifestyle.jpg', alt: 'Dirty French shower gel in use' },
    ],
    fulfillmentType: FULFILLMENT_TYPES.WHITE_LABEL,
    vendorType: VENDOR_TYPES.ROOM23_STOCK,
    inventoryStatus: INVENTORY_STATUS.IN_STOCK,
  ...
  },
  {
    id: 'cake-stroker',
    slug: 'cake-stroker',
    aliases: ['hello-cake-dual-texture-stroker', 'hello-cake-stroker'],
    ...
    relatedSlugs: ['skins-delay-spray', 'cg-oh-my-warming-stimulant', 'cg-pole-polish'],
  },
]

/** Homepage + admin share this SKU until a product document flag is set. */
export const PRODUCT_OF_THE_MONTH_ID = 'cake-stroker'

export const COLLECTIONS = {
  essentials: {
    title: 'Essentials',
    subtitle: 'Lubricants and everyday staples — concentrated formulas held to a quiet standard.',
    description:
      'Medical-grade platinum silicone lubricants in travel, standard, and value sizes.',
  },
  wellness: {
    title: 'Wellness',
    subtitle: 'Sprays, mists, and intimate care — considered pieces for the body.',
    description:
      'Delay spray, botanical mists, warming serums, and daily care from the Room 23 edit.',
  },
  body: {
    title: 'Body',
    subtitle: 'Oils, gels, and sensorial rituals for skin and shower.',
    description: 'Hydrating oils, shower gels, and light mists for a considered daily ritual.',
  },
  toys: {
    title: 'Toys',
...
const BODY_TYPES = new Set(['oil', 'wash', 'mist', 'cream'])
...
export function getCollection(slug) {
  ...
  return {
    title,
    subtitle: 'A considered selection from the Room 23 edit.',
    description: `Shop ${title} from Room 23.`,
  }
}
...
export function getProductsByCollection(slug) {
  ...
  if (slug === 'body') return PRODUCTS.filter((p) => BODY_TYPES.has(p.filters?.type))
  if (slug === 'essentials') return PRODUCTS.filter((p) => p.category === 'essentials')
...
export function getProductOfTheMonth() {
  const flagged = PRODUCTS.find((p) => p.isProductOfTheMonth || p.isFeatured)
  if (flagged) return flagged
  return getProductById(PRODUCT_OF_THE_MONTH_ID) || null
}
...
export function getProductCanonicalRedirects() {
  return buildProductCanonicalRedirects(PRODUCTS)
}
