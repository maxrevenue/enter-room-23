...
export const PRODUCTS = [
  {
    ...
    image: '/images/products/platinum-silicone-2oz.svg',
    images: [
      { url: '/images/products/platinum-silicone-2oz.svg', alt: 'Platinum Silicone Lubricant 2oz pump bottle' },
      { url: '/images/products/platinum-silicone-detail.svg', alt: 'Silicone lubricant pump detail' },
      { url: '/images/products/packaging-plain.svg', alt: 'Unbranded outer carton illustration' },
    ],
  ...
  },
  {
    ...
    image: '/images/products/platinum-silicone-4oz.svg',
    images: [
      { url: '/images/products/platinum-silicone-4oz.svg', alt: 'Platinum Silicone Lubricant 4oz pump bottle' },
      { url: '/images/products/platinum-silicone-detail.svg', alt: 'Silicone lubricant pump detail' },
      { url: '/images/products/packaging-plain.svg', alt: 'Unbranded outer carton illustration' },
    ],
    fulfillmentType: FULFILLMENT_TYPES.WHITE_LABEL,
  ...
  },
  {
    ...
    image: '/images/products/platinum-silicone-8oz.svg',
    images: [
      { url: '/images/products/platinum-silicone-8oz.svg', alt: 'Platinum Silicone Lubricant 8oz pump bottle' },
      { url: '/images/products/platinum-silicone-detail.svg', alt: 'Silicone lubricant pump detail' },
      { url: '/images/products/packaging-plain.svg', alt: 'Unbranded outer carton illustration' },
    ],
    fulfillmentType: FULFILLMENT_TYPES.WHITE_LABEL,
  ...
  },
  {
    ...
    image: '/images/products/obsidian-glass-wand.svg',
    images: [
      { url: '/images/products/obsidian-glass-wand.svg', alt: 'Obsidian Glass Massage Wand on dark ground' },
      { url: '/images/products/obsidian-glass-detail.svg', alt: 'Borosilicate glass wand silhouette detail' },
      { url: '/images/products/packaging-plain.svg', alt: 'Unbranded outer carton illustration' },
    ],
  ...
  },
  {
    ...
    image: '/images/products/midnight-bloom-oil.svg',
    images: [
      { url: '/images/products/midnight-bloom-oil.svg', alt: 'Midnight Bloom Massage Oil glass bottle' },
      { url: '/images/products/midnight-bloom-detail.svg', alt: 'Massage oil bottle and dropper detail' },
      { url: '/images/products/packaging-plain.svg', alt: 'Unbranded outer carton illustration' },
    ],
    fulfillmentType: FULFILLMENT_TYPES.DROPSHIP,
  ...
  },
  {
    ...
    image: '/images/products/noir-silk-blindfold.svg',
    images: [
      { url: '/images/products/noir-silk-blindfold.svg', alt: 'Noir Silk Blindfold folded on dark ground' },
      { url: '/images/products/noir-silk-detail.svg', alt: 'Mulberry silk blindfold texture detail' },
      { url: '/images/products/packaging-plain.svg', alt: 'Unbranded outer carton illustration' },
    ],
    fulfillmentType: FULFILLMENT_TYPES.DROPSHIP,
    vendorType: VENDOR_TYPES.WILLIAMS_DROPSHIP,
