...
export const COLLECTIONS = {
  ...
  vintage: {
    ...
    subtitle: 'Rare and pre-owned intimate objects, each with a history of its own.',
    description: 'A rotating selection of iconic design, rare finds, and collectible pieces — from mid-century to the present.',
  },
  'new-arrivals': {
    title: 'New Arrivals',
