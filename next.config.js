...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/shop/obsidian-glass-massage-wand', destination: '/shop', permanent: true },
      ...
      { source: '/shop/midnight-bloom-massage-oil', destination: '/shop', permanent: true },
      ...
      { source: '/shop/noir-silk-blindfold', destination: '/shop', permanent: true },
    ]
  },
  async headers() {
    return [
